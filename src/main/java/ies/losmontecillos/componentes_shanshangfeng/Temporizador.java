...
public class Temporizador extends VBox {
    ...
    public Temporizador() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Tempolizador.fxml"));
    ...
    private void handleIniciar(ActionEvent event) {
        try {
            int tiempoInicial = Integer.parseInt(campoTiempo.getText().trim()); // Corrección: .trim()
